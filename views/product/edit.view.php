                        ...
                        <div class="divide-y divide-gray-200">
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div class="flex flex-col">
                                    ...
                                    <input type="text" value="<?= $product->name ?>" name="name" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Product name">
                                </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex flex-col">
                                        ...
                                        <div class="relative focus-within:text-gray-600 text-gray-400">
                                            <input type="number" name="price" value="<?= $product->price ?>" class="p-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Price">
                                        </div>
                                    </div>
                                    <div class="flex flex-col">
                                        <label class="leading-loose">Quantity:</label>
                                        <div class="relative focus-within:text-gray-600 text-gray-400">
                                            <input type="number" name="quantity" value="<?= $product->quantity ?>" class="p-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Quantity">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <textarea name="description" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Product description"><?= $product->description ?></textarea>
                                </div>
                            </div>
