        ...
        <div class="container mx-auto px-6">
            <div class="md:flex md:items-center">
                <div class="w-full h-64 md:w-1/2 lg:h-96">
                    <img class="h-full w-full rounded-md object-cover max-w-lg mx-auto" src="<?= $product->featured_image ?>" alt="<?= $product->name ?>">
                </div>
                <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                    ...
                    <div class="flex items-center mt-6">
                        ...
                        <?php endif; ?>
                        <button @click="cartOpen = !cartOpen" class="mx-2 text-gray-600 border rounded-md p-2 hover:bg-gray-200 focus:outline-none">
